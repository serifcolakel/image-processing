...
def band_pass_filter(image, lowcut, highcut):
    ...
    mask[crow-highcut:crow+highcut, ccol-highcut:ccol+highcut] = 0
...
filtered_image = band_pass_filter(image, 10, 50)

plt.subplot(121),plt.imshow(image, cmap='gray'),plt.title('Original Image')
plt.subplot(122),plt.imshow(filtered_image, cmap='gray'),plt.title('Band Pass Filtered Image')
plt.show()